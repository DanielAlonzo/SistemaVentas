            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="icon-user-following"></i> Descuentos Y Rebajas
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="des in arrayDescuento" :key="des.id">
                                    
                                    <td v-text="des.idusuario"></td>
                                    <td v-text="des.tipodescuento"></td>
                                    <td v-text="des.valor"></td>
