            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="icon-basket-loaded"></i> Artículos
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="input-group">
                                   ...
                                   <input type="text" v-model="buscar" @keyup.enter="listarArticulo(1,buscar,criterio)" class="form-control" placeholder="Información a buscar">
                                    <button type="submit" @click="listarArticulo(1,buscar,criterio)" class="btn btn-info"><i class="fa fa-search"></i> Buscar</button>
                                </div>
                            </div>
                        </div>
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="articulo in arrayArticulo" :key="articulo.id">
                                    ...
                                    <td>
                                        <button type="button" @click="abrirModal('articulo', 'actualizar', articulo)" class="btn btn-primary btn-sm" >
                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="email" v-model="codigo" class="form-control" placeholder="Código de barras">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" style="margin-left: 10px" v-if="tipoAccion==1" class="btn btn-primary" @click="registrarArticulo()">Guardar</button>
                            <button type="button" style="margin-left: 10px" v-if="tipoAccion==2" class="btn btn-primary" @click="actualizarArticulo()">Actualizar</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
    ...
    export default {
        ...
        methods : {
            ...
            cambiarPagina(page, buscar, criterio){
                ...
                me.listarArticulo(page, buscar, criterio);//visualiza los datos de la pagina enviada
            },
            registrarArticulo(){
